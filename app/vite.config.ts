...
// Baked into the build so More.tsx can show exactly which commit is live -
// lets anyone confirm they're on the latest deploy (or spot a stale
// service-worker cache) without needing server/CI access.
function commitSha() {
  try {
