...
const publicProfileInvites = require("./publicProfileInvites");
const publicGuardianInvite = require("./publicGuardianInvite");
...
router.use("/public/invites", publicProfileInvites);
router.use("/public/guardian-invite", publicGuardianInvite);
